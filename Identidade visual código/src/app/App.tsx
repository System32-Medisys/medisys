      ...
      <header className="fixed top-0 inset-x-0 z-50 bg-white/97 backdrop-blur-sm border-b border-blue-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 cursor-pointer select-none">
            ...
            <span className="text-lg font-extrabold text-blue-950 tracking-tight">
              Med<span className="text-blue-600">Agenda</span>
            </span>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-7">
            {["Quem Somos", "Como Funciona", "Para Médicos", "Para Hospitais", "Blog"].map((l) => (
              <a key={l} href="#" className="text-sm font-medium text-slate-600 hover:text-blue-700 transition-colors">
                {l}
              </a>
            ))}
          </nav>
        ...
        {mobileOpen && (
          ...
          >
            {["Quem Somos", "Como Funciona", "Para Médicos", "Para Hospitais", "Blog"].map((l) => (
              <a key={l} href="#" className="block py-2 text-sm font-medium text-slate-600">{l}</a>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
          ...
          <div className="border-t border-slate-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-2">
            <span className="text-[11px] text-slate-600">
              © 2024 MedAgenda Tecnologia em Saúde S.A. Todos os direitos reservados.
            </span>
            <span className="text-[11px] text-slate-600">
              CNPJ 12.345.678/0001-90 · Reg. ANS 41234-9
            </span>
          </div>
        </div>
      </footer>
