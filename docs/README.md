# Documentação do Medisys

Esta pasta reúne a documentação funcional do sistema de agendamento médico utilizado por uma clínica.

## Documentos

1. [Visão geral](01-visao-geral.md)
2. [Usuários e permissões](02-usuarios-permissoes.md)
